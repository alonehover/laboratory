(function () {
    ...
    Runner.spriteDefinition = {
        LDPI: {
            MARK_LARGE_STONE: { x: 266, y: 5 }, // 大障碍物
            MARK_LARGE_M: { x: 288, y: 5 }, // 大障碍物
            MARK_LARGE_BUILDING: { x: 354, y: 5 }, // 大障碍物
            MARK_S_TREE: { x: 223, y: 5 }, // 小障碍物
            MARK_S_TREE2: { x: 223, y: 5 }, // 小障碍物
            MARK_S_BRIDGE: { x: 115, y: 5 }, // 小障碍物
            ...
            TREX: { x: 681, y: 5 }, // 人物的开始坐标
            STAR: { x: 638, y: 5 }
        },
        HDPI: {
            MARK_LARGE_STONE: { x: 532, y: 10 }, // 大障碍物
            MARK_LARGE_M: { x: 576, y: 10 }, // 大障碍物
            MARK_LARGE_BUILDING: { x: 708, y: 10 }, // 大障碍物
            MARK_S_TREE: { x: 447, y: 10 }, // 小障碍物
            MARK_S_TREE2: { x: 447, y: 10 }, // 小障碍物
            MARK_S_BRIDGE: { x: 230, y: 10 }, // 小障碍物
    ...
    Runner.prototype = {
        ...
        init: function () {
            ...
            if(!document.querySelector("." + Runner.classes.CONTAINER)) {
        ...
        createTouchController: function () {
            this.touchController = document.getElementById('jump');
            this.stopController = document.getElementById('stop');
    ...
    Obstacle.types = [
        {
            ...
            minSpeed: 0,
            collisionBoxes: [
                new CollisionBox(2, 12, 15, 16),
                new CollisionBox(7, 2, 4, 4)
            ]
        },
        {
            type: 'MARK_S_TREE2',
            ...
            minSpeed: 0,
            collisionBoxes: [
                new CollisionBox(2, 12, 36, 16),
                new CollisionBox(7, 2, 4, 4),
                new CollisionBox(28, 2, 4, 4)
            ]
        },
        {
            type: 'MARK_S_BRIDGE',
        ...
        },
        {
            ...
            minSpeed: 6,
            collisionBoxes: [
                new CollisionBox(2, 22, 28, 4),
                new CollisionBox(15, 2, 4, 3),
                new CollisionBox(2, 6, 28, 2)
            ]
        },
        {
            ...
            minSpeed: 3,
            collisionBoxes: [
                new CollisionBox(4, 2, 2, 6),
                new CollisionBox(2, 18, 4, 16),
            ]
        },
        {
            ...
            minSpeed: 7,
            collisionBoxes: [
                new CollisionBox(25, 2, 8, 12),
                new CollisionBox(2, 23, 6, 20),
                new CollisionBox(45, 6, 8, 12),
                new CollisionBox(65, 27, 6, 16)
            ]
        },
        {
            type: 'MARK_LARGE_M',
    ...
    Trex.collisionBoxes = {
        ...
        // ],
        RUNNING: [
            new CollisionBox(12, 4, 24, 10),
            new CollisionBox(14, 30, 8, 16),
            new CollisionBox(39, 28, 7, 26)
        ]
    };
    ...
    document.addEventListener("DOMContentLoaded", function() {
        window.runner = new Runner("#tff-wrapper");
    })
})();